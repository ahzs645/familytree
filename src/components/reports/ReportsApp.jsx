...
const BUILDERS = [
  ...
  { id: 'narrative', label: 'Narrative Report', needsSubject: true, usesGenerations: true, run: (rn, o) => buildNarrativeReport(rn, o.generations || 4) },
  ...
  { id: 'register', label: 'Register Report', needsSubject: true, usesGenerations: true, run: (rn, o) => buildRegisterReport(rn, o.generations || 4) },
  { id: 'descendancy', label: 'Descendancy Report', needsSubject: true, usesGenerations: true, run: (rn, o) => buildDescendancyReport(rn, o.generations || 5) },
  ...
  { id: 'facts-list', label: 'Facts List', needsSubject: false, run: () => buildFactsListReport() },
  { id: 'marriage-list', label: 'Marriage List', needsSubject: false, run: () => buildMarriageListReport() },
  { id: 'anniversary-list', label: 'Anniversary List', needsSubject: false, run: () => buildAnniversaryList() },
  { id: 'timeline-report', label: 'Timeline Report', needsSubject: false, run: () => buildTimelineReport() },
  { id: 'media-gallery-report', label: 'Media Gallery Report', needsSubject: false, run: () => buildMediaGalleryReport() },
  { id: 'status-report', label: 'Status Report', needsSubject: false, run: () => buildStatusReport() },
  { id: 'today-report', label: 'Today Report', needsSubject: false, run: () => buildTodayReport() },
  { id: 'changes-list', label: 'Changes List', needsSubject: false, run: () => buildChangesListReport() },
  { id: 'map-report', label: 'Map Report', needsSubject: false, run: () => buildMapReport() },
