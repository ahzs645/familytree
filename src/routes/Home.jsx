...
const SECTIONS = [
  ...
  { to: '/chart-split', title: 'Chart Split Wizard', body: 'Create focused saved chart sets by generation, branch, surname, lineage, or ancestor/descendant pair.' },
  ...
  { to: '/custom-validation', title: 'Custom Data Rules', body: 'Define scoped validation schemas with required fields, types, enums, references, and date constraints.' },
  ...
  { to: '/lineages', title: 'Lineages', body: 'Assign named all-descendant, patrilineal, or matrilineal lineages and sync them to person groups.' },
  { to: '/reference-numbering', title: 'Reference Numbering', body: 'Calculate Ahnentafel, d’Aboville, Henry, and generation-relative reference numbers.' },
