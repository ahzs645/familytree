...
export async function loadSnapshot() {
  ...
  const [
    ...
    db.query('StorySectionRelation', { limit: 100000 }),
  ...
  const records = [
    ...
    ...rawStorySectionRelations.records,
  ...
  return {
    ...
    storySectionRelations: rawStorySectionRelations.records,
