...
export async function loadTribalAffiliationModel(db) {
  ...
  const realAffiliations = affiliationRows.records.map((record) => ({
    ...
    dataPackage: readField(record, ['dataPackage'], ''),
    dataPackageSourceId: readField(record, ['dataPackageSourceId'], ''),
    dataPackagePageIndex: readField(record, ['dataPackagePageIndex'], ''),
