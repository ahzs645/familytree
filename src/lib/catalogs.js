...
export const PERSON_EVENT_TYPES = [
  ...
  { id: 'LDSBaptism', label: 'LDS Baptism' },
  { id: 'LDSChildSealing', label: 'LDS Sealing To Parents' },
  { id: 'LDSConfirmation', label: 'LDS Confirmation' },
  { id: 'LDSEndowment', label: 'LDS Endowment' },
  { id: 'LDSInitiatory', label: 'LDS Initiatory' },
...
export const FAMILY_EVENT_TYPES = [
  ...
  { id: 'LDSSpouseSealing', label: 'LDS Sealing To Spouse' },
